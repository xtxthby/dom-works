...
// 2   привязка через document.querySelector до html
// класів, тегів
...
// // привязка через document.querySelectorAll до всіх вказаних
...
//  3    запит на значення через id привязу,
//   запит на посилання через клас
// запит на адресу через клас зі зміною адреси
...
//  4   запит на текст і зміна заголовку через textContent
...
// text.textContent =
// "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nostrum tenetur assumenda fugiat maxime,soluta aspernatur quasi nihil in asperiores ad distinctio illo et debitis error iure voluptate numquam maiores nisi.Lorem ipsum dolor sitamet, consectetur adipisicing elit.Nostrum tenetur assumenda fugiat maxime, soluta aspernatur quasi nihil in asperiores ad distinctio illo et debitis error iure voluptate numquam maiores nisi!";
// list.after(text);
...
//  13 властивість innerHTML зміна
// const title = document.querySelector(".article .title");
// title.innerHTML = 'New and <span class="accent">improved</span> title';


//  14 властивість innerHTML зміна
...
//  15 властивість innerHTML додавання
